...
$_LANG['bonus_type'] = 'Loại quà tặng';
$_LANG['bonus_list'] = 'Danh sách quà tặng';
$_LANG['type_name'] = 'Tên';
$_LANG['type_money'] = 'Số tiền tặng';
$_LANG['min_goods_amount'] = 'Số tiền t.toán tối thiểu';
$_LANG['notice_min_goods_amount'] = 'Chỉ tính tổng số tiền thanh toán sản phẩm để tặng quà hoặc gói quà miễn phí (điều kiện)';
...
$_LANG['all_goods'] = 'Sản phẩm tùy chọn';
$_LANG['send_bouns_goods'] = 'Provide the type bonus product';
$_LANG['remove_bouns'] = 'Hủy quà tặng';
$_LANG['all_remove_bouns'] = 'Hủy tất cả';
...
$_LANG['bonustype_edit'] = 'Sửa loại quà tặng';
...
$_LANG['type_name_exist'] = 'Tên loại quà tặng này đã tồn tại.';
...
$_LANG['send_bonus_count'] = 'Số lượng';
$_LANG['start_bonus_sn'] = 'Mã bắt đầu';
...
$_LANG['select_rank'] = 'Tất cả người dùng...';
$_LANG['keywords'] ='Keywords: ';
$_LANG['userlist'] ='User list: ';
$_LANG['search_users'] ='Search user';
$_LANG['confirm_send_bonus'] ='Gửi đi';
