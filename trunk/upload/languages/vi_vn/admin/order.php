...
$_LANG['cs'][PS_PAYING] = 'H.thức t.toán';
...
$_LANG['search_goods'] ='Tìm sản phẩm theo ID, tên, mã';
...
$_LANG['price_note'] ='Chú ý: Đã tao gồm giá phụ kiện đi kèm theo sản phẩm.';
$_LANG['select_pack'] ='Select packing';
$_LANG['select_card'] ='Select greeting card';
$_LANG['select_shipping'] ='Select shipping method';
$_LANG['want_insure'] ='Tôi muốn mua bảo hiểm';
$_LANG['update_goods'] ='Cập nhật sản phẩm';
$_LANG['notice_user'] ='<Strong>Chú ý:</Strong>Search result only display the first 20 records, if didn\'t find correlative member, please search accurately. Moreover, if the member registers from the forum and don\'t register in shop, can\'t also find out, need register in the shop first.';
...
$_LANG['js_languages']['input_price'] = 'Giá tùy chọn';
