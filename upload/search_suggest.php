...
//Xác định xem người dùng có nhập nội dung tìm kiếm không
...
if($keywords!="")
{
  ...
  while ($row = $db->FetchRow($res))
  {
  		...
  		$result['content']=$result['content']."<li onmouseout='javascript:suggestOut(this);' onmouseover='javascript:suggestOver(this);' onclick='javascript:form_submit(this);'><span class='suggest-key'>".$row['keyword']."</span><span class='suggest-result'>Có ".$count." kết quả</span></li>";
  }
